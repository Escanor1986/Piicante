...
app.use(
  session({
    secret: process.env.SESSION_SECRET, // il s'agit du même secret que pour gérer/signer les cookies. Nous permet de signer la session et de sécuriser l'Id par la même occasion
